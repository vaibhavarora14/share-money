...
SUPABASE_SERVICE_ROLE_KEY=your_supabase_service_role_key  # Required for admin API (add member functionality)
```
...
1. Set environment variables in Netlify dashboard:
   - `SUPABASE_URL`
   - `SUPABASE_ANON_KEY`
   - `SUPABASE_SERVICE_ROLE_KEY` (required for add member functionality)
