      ...
      <div className="app" id="main-content">
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Android Button */}
              <a
                href="mailto:contact@sharedmoney.app?subject=ShareMoney Android Beta Access Request&body=Hi! I'd like to request access to the ShareMoney Android beta app. Thank you!"
        ...
        >
          <div className="container" style={{ textAlign: "center" }}>
            ...
            >
              <a
                href="mailto:contact@sharedmoney.app"
                style={{
