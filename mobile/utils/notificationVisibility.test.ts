...
import { unreadNotificationIdsFromViewTokens } from "./notificationVisibility.ts";

function notification(id: string, readAt: string | null = null): TransactionNotification {
...
Deno.test("visible notification rows exclude headers, read rows, and duplicate ids", () => {
  ...
  assertEquals(unreadNotificationIdsFromViewTokens([
