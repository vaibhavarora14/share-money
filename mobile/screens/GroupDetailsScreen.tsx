...
import { useAddMember, useRemoveMember, useDeleteGroup } from "../hooks/useGroupMutations";
...
export const GroupDetailsScreen: React.FC<GroupDetailsScreenProps> = ({
  ...
  } = useTransactions(group.id);

  const {
    data: invitations = [],
    isLoading: invitationsLoading,
  } = useGroupInvitations(group.id);
  ...
  if (groupError) {
    return (
      ...
      >
        ...
        >
          {groupError instanceof Error ? groupError.message : "Unknown error occurred"}
        </Text>
